        ...
        _tpl: [
            '<div class="wrapper-content clearfix">',
                '<div class="input-section">',
                    '<div class="lowin">',
                        '<label>用户名</label>',
                        '<div class="lowin-input js-email"><input type="email"  style="background-color: rgba(68, 160, 179, 0.15);"' +
                        ' placeholder="username"></div>',
                    '</div>',
                    '<div class="lowin">',
                        '<label>密码</label>',
                        '<div class="lowin-input js-pwd"><input type="password"  style="background-color: rgba(68, 160, 179, 0.15);"' +
                    ...
                    '<div class="form-group">',
                        '<div class="col-input-login">',
                            '<a class="btn btn-mylogin js-login" href="javascript:void(0);">登陆</a>',
                            '<a class="btn btn-myreg js-register" href="javascript:void(0);">注册</a>',
                        '</div>',
                    '</div>',
                '</div>',
            '</div>'].join(''),
